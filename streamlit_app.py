...
genai.configure(api_key='AIzaSyDEx1fX4Fn2W6MLgbbwIAHXcpbOBhgM3ag')
...
st.sidebar.write("Made by Hridya Sharma")
st.sidebar.write("Powered by google gemini ai")
st.header("RoboBill")
st.subheader("Made by Hridya Sharma")
...
ssumbmit= st.button("Let's goooooo!")
